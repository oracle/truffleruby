...
# CONFIGURATION
local overlay = "25865dc1e595899a063a0ad9d0702e0aa5bcbd3c";
...
local composition_environment = utils.add_inclusion_tracking(part_definitions, "$", false) {
  ...
  test_builds:
...

    {
      ...
      "ruby-test-cexts-linux-aarch64":  $.platform.linux_aarch64 + $.jdk.v11 + $.env.jvm + gate + $.use.gem_test_pack + $.use.sqlite331 + $.run.test_cexts,
