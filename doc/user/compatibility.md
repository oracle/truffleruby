...
`void *truffle_handle_for_managed(VALUE managed)` and `VALUE
truffle_managed_from_handle(void *native)` may help you work around this
...
*truffle_release_handle(void *native)`. Use `VALUE
