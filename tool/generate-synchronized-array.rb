...
file = 'src/main/ruby/truffleruby/core/truffle/synchronized_array.rb'
...
# Generated by tool/generate-synchronized-array.rb

# This class is used for $LOADED_FEATURES and $LOAD_PATH.

class Truffle::SynchronizedArray < Array
RUBY
...
read_only_methods.uniq.sort.each do |method|
  code << <<-RUBY
  def #{method}(*args, &block)
    copy = TruffleRuby.synchronized(self) { Array.new self }
