...
class Test_Load_stringify_symbols < Test::Unit::TestCase
  def test_load_stringify_symbol_required_extensions
    require 'c/load/stringify_symbols'
    require 'c/load/stringify_target'
    r1 = StringifySymbols.stringify_symbol("c/load/stringify_target", "stt_any_method")
    assert_not_nil r1
    r2 = StringifySymbols.stringify_symbol("c/load/stringify_target.so", "stt_any_method")
