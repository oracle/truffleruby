...
exclude :test_each_line_limit_0, "#each relies on IO#gets that doesn't raise error when limit=0"
...
exclude :test_readlines_limit_0, "#readlines relies on IO#gets that doesn't raise error when limit=0"
...
exclude :test_readlines_chomp, "TypeError: wrong argument type Hash (expected Integer)"
exclude :test_gets_chomp, "TypeError: wrong argument type Hash (expected Integer)"
exclude :test_readline_chomp, "TypeError: wrong argument type Hash (expected Integer)"
