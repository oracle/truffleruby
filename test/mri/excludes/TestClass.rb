...
exclude :test_clone_when_method_exists_on_singleton_class_of_singleton_class, "NoMethodError: undefined method `s2_method' for #<Class:#<#<Class:0x588>:0x5a8>>"
...
exclude :test_redefinition_mismatch, "Expected \"1:Integer is not a class\" to include \"/Users/andrykonchin/projects/truffleruby-ws/truffleruby/test/mri/tests/ruby/test_class.rb:709: previous definition\"."
