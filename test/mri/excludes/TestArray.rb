...
exclude :test_count, "| | | | | Error while formatting Ruby exception: | -:4:in `==': stack level too deep (SystemStackError)"
...
exclude :test_permutation_stack_error, "Exception raised: <#<SystemStackError: stack level too deep from java.nio.HeapCharBuffer.<init>(HeapCharBuffer.java:85)>>"
...
exclude :test_repeated_combination_stack_error, "Exception raised: <#<SystemStackError: stack level too deep from java.nio.CharBuffer.limit(CharBuffer.java:1571)>>"
...
exclude :test_sort_with_replace, "Exception raised: <#<SystemStackError: stack level too deep from java.lang.StringLatin1.getChars(StringLatin1.java:201)>>"
