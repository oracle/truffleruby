...
exclude :test_count, "| | | Error while formatting Ruby exception: | <internal:core> core/string.rb:487:in `encode': stack level too deep (SystemStackError)"
...
exclude :test_permutation_stack_error, "Exception raised: <#<SystemStackError: stack level too deep from java.nio.CharBuffer.<init>(CharBuffer.java:319)>>"
...
exclude :test_repeated_combination_stack_error, "Exception raised: <#<SystemStackError: stack level too deep from jdk.internal.misc.InternalLock.lock(InternalLock.java:74)>>"
...
exclude :test_sort_with_replace, "Exception raised: <#<SystemStackError: stack level too deep from java.nio.CharBuffer.<init>(CharBuffer.java:319)>>"
