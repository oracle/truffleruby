...
exclude :test_dup_clone, "NoMethodError: undefined method `foo=' for #<Proc:0xfd8 /b/b/e/main/test/mri/tests/ruby/test_proc.rb:374>"
...
exclude :test_to_s, "Expected /^#<Proc:0x\\h+ \\(lambda\\)>$/ to match \"#<Proc:0x5be8 <internal:core> core/post.rb:78 (lambda)>\"."
