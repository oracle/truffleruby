...
exclude :test_mutex_deadlock, "| #<Thread:0x4a8 -:4 run> terminated with exception (report_on_exception is true): | -:6:in `block in <main>': undefined method `set_scheduler' for Fiber:Class (NoMethodError)"
