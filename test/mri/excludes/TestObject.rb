...
exclude :test_method_missing, "[ArgumentError] exception expected, not #<NoMethodError: undefined method `method_missing' for #<#<Class:0x8e8>:0x928>>."
...
exclude :test_respond_to_missing, "<#<Method: #<Class:0xd78>#foobar(*rest) /home/nirvdrum/dev/workspaces/truffleruby-ws/truffleruby/test/mri/tests/ruby/test_object.rb:567>> expected but was <#<Method: #<Class:0xd78>#foobar(*rest) /home/nirvdrum/dev/workspaces/truffleruby-ws/truffleruby/test/mri/tests/ruby/test_object.rb:567>>."
