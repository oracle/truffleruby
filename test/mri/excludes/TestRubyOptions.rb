...
exclude :test_verbose, "Expected /^ruby 3\\.3\\.5(?:[p ]|dev|rc).*? \\[x86_64\\-linux\\]$/ to match \"truffleruby 24.2.0-dev-681a9ab0, like ruby 3.3.5, GraalVM CE Native [x86_64-linux]\"."
exclude :test_version, "Expected /^ruby 3\\.3\\.5(?:[p ]|dev|rc).*? \\[x86_64\\-linux\\]$/ to match \"truffleruby 24.2.0-dev-681a9ab0, like ruby 3.3.5, GraalVM CE Native [x86_64-linux]\"."
