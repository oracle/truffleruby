 ...
 */
public final class RubyLexer implements MagicCommentParser.MagicCommentHandler {
        ...
        loop: for (;;) {
            ...
            switch (c) {
                ...
                case '#': { /* it's a comment */
                    ...
                    if (!tokenSeen) {
                        if (!MagicCommentParser.parser_magic_comment(new TStringWithEncoding(lexb, encoding), lex_p,
                                lex_pend - lex_p,
                                this)) {
                            if (comment_at_top()) {
    ...
    public boolean onMagicComment(String name, TruffleString value) {
        if (MagicCommentParser.isMagicEncodingComment(name)) {
    ...
    protected void set_file_encoding(int str, int send) {
        ...
        TruffleString encoding = MagicCommentParser.get_file_encoding(magicLine);
        if (encoding != null) {
            setEncoding(encoding);
        }
    }
