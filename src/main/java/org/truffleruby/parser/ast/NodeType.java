...
public enum NodeType {
    ...
    BACKREFNODE, BEGINNODE, BIGNUMNODE,  BLOCKARGNODE, BLOCKNODE,
    ...
    GLOBALASGNNODE, GLOBALVARNODE, HASHNODE, IFNODE, INSTASGNNODE, INSTVARNODE, 
    ITERNODE, LISTNODE, LOCALASGNNODE, LOCALVARNODE, MATCH2NODE, MATCH3NODE, MATCHNODE, MODULENODE,
    NEXTNODE, NILNODE, NTHREFNODE, OPASGNANDNODE,
    OPASGNNODE, OPASGNORNODE, OPELEMENTASGNNODE, ORNODE, PREEXENODE, POSTEXENODE, REDONODE, 
    REGEXPNODE, RESCUEBODYNODE, RESCUENODE, RETRYNODE, RETURNNODE, SCLASSNODE, 
    ...
    ZARRAYNODE,  ZSUPERNODE,  ROOTNODE, ATTRASSIGNNODE, ARGSPUSHNODE,
    OPTARGNODE,  LAMBDANODE, MULTIPLEASGNNODE, RESTARG, ENCODINGNODE,
    LITERALNODE,  KEYWORDARGNODE, KEYWORDRESTARGNODE, RATIONALNODE, BIGRATIONALNODE, COMPLEXNODE,
