...
public abstract class OutgoingForeignCallNode extends RubyBaseNode {
    ...
    protected Object sendOutgoing(
            Object receiver, String name, Object[] args,
            @Cached(value = "name", allowUncached = true) @Shared("name") String cachedName,
            @Cached(parameters = "PRIVATE") @Shared("dispatch") CallDispatchHeadNode dispatchNode) {
    ...
    protected Object redirectToTruffleInterop(
            ...
            @CachedContext(RubyLanguage.class) RubyContext context,
            @Cached(parameters = "PRIVATE") @Shared("dispatch") CallDispatchHeadNode callDispatchHeadNode,
