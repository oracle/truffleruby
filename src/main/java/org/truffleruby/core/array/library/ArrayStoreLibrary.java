...
public abstract class ArrayStoreLibrary extends Library {
    ...
    /** Clear the part of the array starting at {@code start} and extending for {@code length} elements, so that that
     * range does not retain references to objects/memory/resources. This can be understood as "nulling out" that
     * part of the array, and will do nothing for primitive arrays. */
