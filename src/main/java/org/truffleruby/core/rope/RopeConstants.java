...
public class RopeConstants {
    ...
    // puts
    // puts "public static final List<Rope> ENCODING_NAMES = Arrays.asList(#{names.map {|n| n.upcase.gsub('-','_')}.join(', ')});"
    ...
    public static final List<Rope> ENCODING_NAMES = Arrays.asList(
            ASCII_8BIT,
            US_ASCII,
            UTF_8,
            BIG5,
