...
public class OptionsCatalog {
    ...
    public static final StringOptionDescription ORIGINAL_INPUT_FILE = new StringOptionDescription("original_input_file", "Original input file for the Ruby interpreter", "");
