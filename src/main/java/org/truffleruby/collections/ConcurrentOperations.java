...
public abstract class ConcurrentOperations {
    ...
    /**
     * Replaces {@link ConcurrentHashMap#computeIfAbsent(Object, Function)} as it does not scale. The JDK method takes a
     * monitor for every access if the key is present. See https://bugs.openjdk.java.net/browse/JDK-8161372 which only
