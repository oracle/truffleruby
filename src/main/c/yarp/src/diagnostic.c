...
#define PM_DIAGNOSTIC_ID_MAX 256
...
static const pm_diagnostic_data_t diagnostic_messages[PM_DIAGNOSTIC_ID_MAX] = {
    ...
    [PM_ERR_BEGIN_LONELY_ELSE]                  = { "unexpected `else` in `begin` block; else without rescue is useless", PM_ERROR_LEVEL_FATAL },
...
pm_diagnostic_id_human(pm_diagnostic_id_t diag_id) {
    switch (diag_id) {
        ...
        case PM_ERR_PARAMETER_NAME_REPEAT: return "parameter_name_repeat";
