...
prettyprint_node(yp_buffer_t *buffer, yp_parser_t *parser, yp_node_t *node) {
    switch (node->type) {
        ...
        case YP_NODE_CALL_NODE: {
            ...
            snprintf(flags_buffer, sizeof(flags_buffer), "+%d", ((yp_call_node_t *)node)->flags);
        ...
        case YP_NODE_INTERPOLATED_REGULAR_EXPRESSION_NODE: {
            ...
            yp_buffer_append_str(buffer, ", ", 2);            char flags_buffer[12];
            snprintf(flags_buffer, sizeof(flags_buffer), "+%d", ((yp_interpolated_regular_expression_node_t *)node)->flags);
            yp_buffer_append_str(buffer, flags_buffer, strlen(flags_buffer));
            yp_buffer_append_str(buffer, ")", 1);
            break;
        }
        ...
        case YP_NODE_RANGE_NODE: {
            ...
            yp_buffer_append_str(buffer, ", ", 2);            char flags_buffer[12];
            snprintf(flags_buffer, sizeof(flags_buffer), "+%d", ((yp_range_node_t *)node)->flags);
            yp_buffer_append_str(buffer, flags_buffer, strlen(flags_buffer));
            yp_buffer_append_str(buffer, ")", 1);
            break;
        }
        ...
        case YP_NODE_REGULAR_EXPRESSION_NODE: {
            ...
            yp_buffer_append_str(buffer, "\"", 1);
            yp_buffer_append_str(buffer, ", ", 2);            char flags_buffer[12];
            snprintf(flags_buffer, sizeof(flags_buffer), "+%d", ((yp_regular_expression_node_t *)node)->flags);
            yp_buffer_append_str(buffer, flags_buffer, strlen(flags_buffer));
            yp_buffer_append_str(buffer, ")", 1);
            break;
        }
