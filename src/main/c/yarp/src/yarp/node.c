...
yp_node_t *
yp_node_block_node_create(yp_parser_t *parser, yp_node_t *parameters, yp_node_t *statements, const yp_location_t *opening_loc, const yp_location_t *closing_loc, yp_location_t *location) {
  yp_node_t *node = yp_node_alloc(parser);
  *node = (yp_node_t) { .type = YP_NODE_BLOCK_NODE, .location = *location, .as.block_node = { .parameters = parameters, .statements = statements, .opening_loc = *opening_loc, .closing_loc = *closing_loc } };
  return node;
}
...
yp_node_hash_node_create(yp_parser_t *parser, const yp_token_t *opening, const yp_token_t *closing) {
  yp_node_t *node = yp_node_alloc(parser);
  *node = (yp_node_t) { .type = YP_NODE_HASH_NODE, .location = { .start = (opening->type == YP_TOKEN_NOT_PROVIDED ? NULL : opening->start), .end = (closing->type == YP_TOKEN_NOT_PROVIDED ? NULL : closing->end) }, .as.hash_node = { .opening = *opening, .closing = *closing } };
...
yp_node_interpolated_string_node_create(yp_parser_t *parser, const yp_token_t *opening, const yp_token_t *closing) {
  yp_node_t *node = yp_node_alloc(parser);
  *node = (yp_node_t) { .type = YP_NODE_INTERPOLATED_STRING_NODE, .location = { .start = (opening->type == YP_TOKEN_NOT_PROVIDED ? NULL : opening->start), .end = (closing->type == YP_TOKEN_NOT_PROVIDED ? NULL : closing->end) }, .as.interpolated_string_node = { .opening = *opening, .closing = *closing } };
...
yp_node_interpolated_symbol_node_create(yp_parser_t *parser, const yp_token_t *opening, const yp_token_t *closing) {
  yp_node_t *node = yp_node_alloc(parser);
  *node = (yp_node_t) { .type = YP_NODE_INTERPOLATED_SYMBOL_NODE, .location = { .start = (opening->type == YP_TOKEN_NOT_PROVIDED ? NULL : opening->start), .end = (closing->type == YP_TOKEN_NOT_PROVIDED ? NULL : closing->end) }, .as.interpolated_symbol_node = { .opening = *opening, .closing = *closing } };
...
yp_node_t *
yp_node_local_variable_read_node_create(yp_parser_t *parser, const yp_token_t *name) {
  yp_node_t *node = yp_node_alloc(parser);
  *node = (yp_node_t) { .type = YP_NODE_LOCAL_VARIABLE_READ_NODE, .location = { .start = name->start, .end = name->end }, .as.local_variable_read_node = { .name = *name } };
  return node;
}

// Allocate a new LocalVariableWriteNode node.
yp_node_t *
yp_node_local_variable_write_node_create(yp_parser_t *parser, const yp_token_t *name, const yp_token_t *operator, yp_node_t *value) {
  yp_node_t *node = yp_node_alloc(parser);
  *node = (yp_node_t) { .type = YP_NODE_LOCAL_VARIABLE_WRITE_NODE, .location = { .start = name->start, .end = (value == NULL ? name->end : value->location.end) }, .as.local_variable_write_node = { .name = *name, .operator = *operator, .value = value } };
  return node;
}
...
yp_node_multi_write_node_create(yp_parser_t *parser, const yp_token_t *operator, yp_node_t *value, const yp_location_t *lparen_loc, const yp_location_t *rparen_loc) {
  yp_node_t *node = yp_node_alloc(parser);
  *node = (yp_node_t) { .type = YP_NODE_MULTI_WRITE_NODE, .location = { .start = NULL, .end = NULL }, .as.multi_write_node = { .operator = *operator, .value = value, .lparen_loc = *lparen_loc, .rparen_loc = *rparen_loc } };
...
yp_node_parameters_node_create(yp_parser_t *parser, yp_node_t *rest, yp_node_t *keyword_rest, yp_node_t *block) {
  yp_node_t *node = yp_node_alloc(parser);
  *node = (yp_node_t) { .type = YP_NODE_PARAMETERS_NODE, .location = { .start = NULL, .end = (block == NULL ? (keyword_rest == NULL ? NULL : keyword_rest->location.end) : block->location.end) }, .as.parameters_node = { .rest = rest, .keyword_rest = keyword_rest, .block = block } };
...
yp_node_required_destructured_parameter_node_create(yp_parser_t *parser, const yp_token_t *opening, const yp_token_t *closing) {
  yp_node_t *node = yp_node_alloc(parser);
  *node = (yp_node_t) { .type = YP_NODE_REQUIRED_DESTRUCTURED_PARAMETER_NODE, .location = { .start = NULL, .end = NULL }, .as.required_destructured_parameter_node = { .opening = *opening, .closing = *closing } };
...
yp_node_scope_create(yp_parser_t *parser) {
  yp_node_t *node = yp_node_alloc(parser);
  *node = (yp_node_t) { .type = YP_NODE_SCOPE, .location = { .start = NULL, .end = NULL } };
...
yp_node_when_node_create(yp_parser_t *parser, const yp_token_t *when_keyword, yp_node_t *statements) {
  yp_node_t *node = yp_node_alloc(parser);
  *node = (yp_node_t) { .type = YP_NODE_WHEN_NODE, .location = { .start = when_keyword->start, .end = (statements == NULL ? NULL : statements->location.end) }, .as.when_node = { .when_keyword = *when_keyword, .statements = statements } };
