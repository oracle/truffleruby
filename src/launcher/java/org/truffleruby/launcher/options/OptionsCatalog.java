...
public class OptionsCatalog {
    ...
    public static final BooleanOptionDescription PLATFORM_USE_JAVA = new BooleanOptionDescription("ruby.platform.use_java", "Use a pure-Java platform, so no native POSIX", false);
    ...
    public static final BooleanOptionDescription TRACE_CALLS = new BooleanOptionDescription("ruby.trace.calls", "Support tracing (set_trace_func, TracePoint) of method calls", true);
    ...
    public static final BooleanOptionDescription STDLIB_AS_INTERNAL = new BooleanOptionDescription("ruby.stdlib_as_internal", "Mark stdlib sources (really, anything loaded from the TruffleRuby home) as internal", true);
    ...
    public static final BooleanOptionDescription LAZY_TRANSLATION_USER = new BooleanOptionDescription("ruby.lazy_translation.user", "Lazily translation of stdlib, gem and user source files", false);
    ...
    public static final IntegerOptionDescription PACK_UNROLL_LIMIT = new IntegerOptionDescription("ruby.pack.unroll", "If a pack or unpack expression has a loop less than this many iterations, unroll it", 4);
    public static final IntegerOptionDescription PACK_RECOVER_LOOP_MIN = new IntegerOptionDescription("ruby.pack.recover", "If a pack or unpack expression is longer than this, attempt to recover loops", 32);
    ...
    public static final StringArrayOptionDescription CEXTS_LIBRARY_REMAP = new StringArrayOptionDescription("ruby.cexts.remap", "Remap the name of native libraries, written in the form libexample.so=path/to/actual/libexample.so", new String[]{});
