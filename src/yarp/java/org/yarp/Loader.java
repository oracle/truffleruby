...
public class Loader {
    ...
    private Nodes.Node loadNode() {
        ...
        switch (type) {
            ...
            case 18:
                return new Nodes.CallAndWriteNode(loadOptionalNode(), (Nodes.ArgumentsNode) loadOptionalNode(), loadFlags(), loadString(), loadString(), loadNode(), startOffset, length);
            case 19:
                return new Nodes.CallNode(loadOptionalNode(), (Nodes.ArgumentsNode) loadOptionalNode(), loadOptionalNode(), loadFlags(), loadString(), startOffset, length);
            case 20:
                return new Nodes.CallOperatorWriteNode(loadOptionalNode(), (Nodes.ArgumentsNode) loadOptionalNode(), loadFlags(), loadString(), loadString(), loadConstant(), loadNode(), startOffset, length);
            case 21:
                return new Nodes.CallOrWriteNode(loadOptionalNode(), (Nodes.ArgumentsNode) loadOptionalNode(), loadFlags(), loadString(), loadString(), loadNode(), startOffset, length);
            case 22:
