...
public class Loader {
    ...
    private Nodes.Node loadNode() {
        ...
        switch (type) {
            ...
            case 122:
                return new Nodes.UntilNode(loadLocation(), loadNode(), (Nodes.StatementsNode) loadOptionalNode(), startOffset, length);
            case 123:
                return new Nodes.WhenNode(loadLocation(), loadNodes(), (Nodes.StatementsNode) loadOptionalNode(), startOffset, length);
            case 124:
                return new Nodes.WhileNode(loadLocation(), loadNode(), (Nodes.StatementsNode) loadOptionalNode(), startOffset, length);
            case 125:
