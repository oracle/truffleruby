...
public abstract class Nodes {
    ...
    public static final class BlockNode extends Node {
        ...
        public BlockNode(Node parameters, Node statements, Location opening_loc, Location closing_loc, int startOffset, int endOffset) {
            super(startOffset, endOffset);
    ...
    public static final class ConstantPathNode extends Node {
        ...
        public final Token delimiter;
        public final Node child;

        public ConstantPathNode(Node parent, Token delimiter, Node child, int startOffset, int endOffset) {
            super(startOffset, endOffset);
            this.parent = parent;
    ...
    //     bar(**kwargs)
    //     ^^^^^^^^^^^
    public static final class KeywordStarNode extends Node {
        public final Token operator;
        public final Node expression;

        public KeywordStarNode(Token operator, Node expression, int startOffset, int endOffset) {
            super(startOffset, endOffset);
            this.operator = operator;
            this.expression = expression;
        }
        ...
        public <T> T accept(AbstractNodeVisitor<T> visitor) {
            return visitor.visitKeywordStarNode(this);
        }
    }
    ...
    public static final class LambdaNode extends Node {
        ...
        public LambdaNode(Node scope, Token lparen, Node parameters, Token rparen, Node statements, int startOffset, int endOffset) {
            super(startOffset, endOffset);
            this.scope = scope;
            this.lparen = lparen;
            this.parameters = parameters;
    ...
    public static final class LocalVariableReadNode extends Node {
        ...
        public LocalVariableReadNode(Token name, int startOffset, int endOffset) {
            super(startOffset, endOffset);
            this.name = name;
        }
    ...
    public static final class LocalVariableWriteNode extends Node {
        ...
        public LocalVariableWriteNode(Token name, Token operator, Node value, int startOffset, int endOffset) {
            super(startOffset, endOffset);
            this.name = name;
            this.operator = operator;
            this.value = value;
    ...
    public static final class RequiredParameterNode extends Node {
        ...
        public RequiredParameterNode(Token name, int startOffset, int endOffset) {
            super(startOffset, endOffset);
            this.name = name;
        }
    ...
    public static final class Scope extends Node {
        ...
        public Scope(Token[] locals, int startOffset, int endOffset) {
            super(startOffset, endOffset);
            this.locals = locals;
        }
    ...
    //     foo ? bar : baz
    //     ^^^^^^^^^^^^^^^
    public static final class TernaryNode extends Node {
        public final Node predicate;
        public final Token question_mark;
        public final Node true_expression;
        public final Token colon;
        public final Node false_expression;

        public TernaryNode(Node predicate, Token question_mark, Node true_expression, Token colon, Node false_expression, int startOffset, int endOffset) {
            super(startOffset, endOffset);
            this.predicate = predicate;
        ...
        public Node[] childNodes() {
            return new Node[] { predicate, true_expression, false_expression };
        }
