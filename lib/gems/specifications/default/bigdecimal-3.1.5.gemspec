...
Gem::Specification.new do |s|
  ...
  s.files = ["bigdecimal.#{Truffle::Platform::DLEXT}".freeze, "bigdecimal.rb".freeze, "bigdecimal/jacobian.rb".freeze, "bigdecimal/ludcmp.rb".freeze, "bigdecimal/math.rb".freeze, "bigdecimal/newton.rb".freeze, "bigdecimal/util.rb".freeze, "ext/bigdecimal/extconf.rb".freeze]
